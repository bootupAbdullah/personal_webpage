...
const Contact = () => (
  <div className="flex justify-center px-5 md:px-16 py-10 md:py-16">
    <div className="w-full max-w-[920px] flex flex-col md:flex-row items-start gap-8 md:gap-14">
      ...
      <div className="flex-1 flex flex-col gap-5 md:gap-6">
        <div>
          ...
          <h1 className="m-0 mb-2 font-['Space_Grotesk'] font-bold text-[28px] md:text-4xl text-[var(--theme-text-primary)]">Get In Touch</h1>
